...
import {ReassignUserFeedback} from "./components/ReassignUserFeedback";
import {ChangeUserRole} from "./components/ChangeUserRole";
import {ChangeUserRoleFeedback} from "./components/ChangeUserRoleFeedback";
    ...
    return (
        <div className="App">
            <Routes>
                ...
                <Route path={'/reassignUserFeedback'} element={<ReassignUserFeedback/>}/>
                <Route path={'/changeUserRole'} element={<ChangeUserRole/>}/>
                <Route path={'/changeUserRoleFeedback'} element={<ChangeUserRoleFeedback/>}/>
            </Routes>
        </div>
    );
}
